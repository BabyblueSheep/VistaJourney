...
import babybluesheep.vistajourney.item.Aglet;
import babybluesheep.vistajourney.item.GlowThrower;
import babybluesheep.vistajourney.item.PhantomCloak;
import babybluesheep.vistajourney.item.Soullace;
...
public class VistaJourney implements ModInitializer {
	...
	public static final Aglet AGLET = new Aglet(new FabricItemSettings().group(ItemGroup.TOOLS).maxCount(1));
	public static final Soullace SOULLACE = new Soullace(new FabricItemSettings().group(ItemGroup.TOOLS).maxCount(1));
	public static final PhantomCloak PHANTOM_CLOAK = new PhantomCloak(new FabricItemSettings().group(ItemGroup.TOOLS).maxCount(1));
	...
	private static final PlacedFeature RUBY_ORE_GENERATION_PLACE = RUBY_ORE_GENERATION.withPlacement(CountPlacementModifier.of(20), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.getBottom(), YOffset.fixed(96)));
	...
	private static final ConfiguredFeature<?, ?> HUGE_VIOLET_WEBCAP_CONFIG = HUGE_VIOLET_WEBCAP.configure(new HugeMushroomFeatureConfig(BlockStateProvider.of(VistaJourney.VIOLET_WEBCAP_BLOCK.getDefaultState().with(MushroomBlock.DOWN, false)), BlockStateProvider.of(VistaJourney.VIOLET_WEBCAP_STEM.getDefaultState().with(MushroomBlock.UP, false).with(MushroomBlock.DOWN, false)), 1));
	...
	public void onInitialize() {
		...
		Registry.register(Registry.BLOCK, new Identifier("vistajourney", "ruby_block"), RUBY_BLOCK);
		Registry.register(Registry.ITEM, new Identifier("vistajourney", "ruby_block"), new BlockItem(RUBY_BLOCK, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS)));
		...
		Registry.register(Registry.ITEM, new Identifier("vistajourney", "aglet"), AGLET);
		Registry.register(Registry.ITEM, new Identifier("vistajourney", "soullace"), SOULLACE);
		Registry.register(Registry.ITEM, new Identifier("vistajourney", "phantom_cloak"), PHANTOM_CLOAK);
